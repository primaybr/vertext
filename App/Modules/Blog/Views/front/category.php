...
<head>
  ...
  <title><?php echo htmlspecialchars($category['name']); ?> — <?php echo htmlspecialchars($settings['blog_title'] ?? 'Blog'); ?></title>
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    header a { font-weight: 600; color: #4f46e5; font-size: .9375rem; }
...
<div class="container">
  ...
  <?php if (empty($posts)): ?>
  <div class="empty"><p>No posts in this category yet.</p></div>
  <?php else: ?>
  <ul class="post-list">
    ...
    <li class="post-item">
      ...
      <?php endif; ?>
      <a href="<?php echo $baseUrl; ?>/blog/<?php echo htmlspecialchars($post['slug']); ?>">Read more →</a>
    </li>
    <?php endforeach; ?>
  </ul>
  ...
  <nav class="pagination">
    ...
    <?php else: ?>
    <a href="<?php echo $baseUrl; ?>/blog/category/<?php echo htmlspecialchars($category['slug']); ?>?page=<?php echo $i; ?>">
      <?php echo $i; ?>
    </a>
    <?php endif; ?>
    <?php endfor; ?>
