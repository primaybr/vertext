<style>
  .post-back { font-size: .875rem; margin-bottom: 2rem; }
  .post-back a { color: #6b7280; }
  .post-back a:hover { color: #4f46e5; }
  ...
  .field input, .field textarea { width: 100%; padding: .5rem .75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: .9375rem; font-family: inherit; }
