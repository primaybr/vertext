...
<div class="vtx-page-head">
  <div>
    <h1 class="vtx-page-title">
      <a href="<?php echo $baseUrl; ?>/admin/pages" class="text-muted" style="font-weight:400;font-size:1rem;">Pages</a>
      <span class="text-muted mx-1">/</span>
      <i class="pi pi-history me-2 text-primary"></i>Revisions
    </h1>
    <p class="vtx-page-desc">History for: <strong><?php echo htmlspecialchars($page['title'] ?? ''); ?></strong></p>
  </div>
  <button type="button" class="btn btn-outline-secondary btn-sm"
          data-form-url="<?php echo $baseUrl; ?>/admin/pages/<?php echo htmlspecialchars($pageId); ?>/form"
          data-form-title="Edit Page">
    <i class="pi pi-edit me-1"></i> Edit Page
  </button>
</div>
...
<div class="vtx-panel">
  ...
  <div class="vtx-empty">
    ...
    <div class="vtx-empty-desc">Revisions are saved automatically each time you update the page.</div>
  </div>
  <?php else: ?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <button type="button" class="btn btn-outline-secondary btn-sm"
                    data-form-url="<?php echo $baseUrl; ?>/admin/pages/<?php echo htmlspecialchars($pageId); ?>/revisions/<?php echo htmlspecialchars($rev['id']); ?>/diff"
            ...
            <form id="restore-rev-<?php echo $rev['id']; ?>" method="POST"
                  action="<?php echo $baseUrl; ?>/admin/pages/<?php echo htmlspecialchars($pageId); ?>/revisions/<?php echo htmlspecialchars($rev['id']); ?>/restore"
                  style="display:none;">
