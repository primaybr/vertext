...
![Version](https://img.shields.io/badge/version-0.0.7b--alpha-blue)
...
> **Built on [Phuse 1.2.6](https://github.com/primaybr/phuse)** - Vertext is powered by the Phuse framework, which provides the ORM, router, session manager, input helpers, validator, and core utilities.
